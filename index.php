...
<body>
  ...
  <footer id="footer">
          ...
          <div class="col-xl-10">
            <div class="row">
              ...
              <div class="col-lg-3 col-md-6 footer-info">
                <h3>About Woostem</h3>
                <p>Woostem is a responsive database system created by Dev 67. The control system is an open-source software, and can be managed by stockholders and owners with provision.</p>
    ...
    <div class="container">
      ...
      <div class="credits">
        Developed by <a href="mailto:devlewis67@gmail.com">Dev 67</a>
      </div>
    </div>
  </footer><!-- End Footer -->
